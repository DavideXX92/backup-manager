...
namespace ClientDiProva
{
    class Watcher
    {
        ...
        public MyBuffer buffer { get; set; }
        ...
        private void handleDirChange(WatcherChangeTypes change, string path, string oldPath)
        {
            ...
            switch (change)
            {
                ...
                case WatcherChangeTypes.Deleted:
                    operation = buffer.containsThisDir(fsService.getPathFromMonitorDir(path, monitorDir));
                    if (operation != null)
                ...
                case WatcherChangeTypes.Renamed:
                    operation = buffer.containsThisDir(fsService.getPathFromMonitorDir(oldPath, monitorDir));
                    if (operation != null)
                    {
                        operation.path = path;
                    }
